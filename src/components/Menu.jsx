      ...
      <div className="max-w-2xl mx-auto mt-12">
        ...
        >
          <input
            ...
            className="border px-4 py-2 rounded-xl w-full sm:w-1/2 focus:ring-2 focus:ring-blue-400 transition"
          />
          <input
            type="text"
            name="price"
            ...
            onChange={handleChange}
            placeholder="Price"
            className="border px-4 py-2 rounded-xl w-full sm:w-1/4 focus:ring-2 focus:ring-blue-400 transition"
          />
          <button
            type="submit"
            className="bg-gradient-to-r from-blue-600 to-blue-400 text-white px-6 py-2 rounded-xl font-bold hover:scale-105 transition-transform w-full sm:w-auto"
          >
            Add
          </button>
        </form> */}
        ...
        {/* <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {menuItems.map((item, idx) => (
            <li
              key={idx}
              className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg p-4 flex justify-between items-center hover:scale-105 transition-transform backdrop-blur-sm"
            >

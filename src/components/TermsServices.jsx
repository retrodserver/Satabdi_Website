...
function TermsServices() {
  return (
    <section className="mt-16 py-10 px-4 sm:px-8 lg:px-32 min-h-[60vh] bg-white text-blue-900">
      <h2 className="text-3xl font-bold mb-8 text-center">Terms & Services</h2>
      <div className="max-w-3xl mx-auto text-lg leading-relaxed">
        <p>Welcome to Hotel Satabdi. By using our website and services, you agree to the following terms and conditions. Please read them carefully before proceeding.</p>
